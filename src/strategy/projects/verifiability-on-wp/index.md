---
title: "Verifiability on Wikipedia"
...
hero:
    image:
        src: "/strategy/projects/verifiability-on-wp/hero.opt.webp"
...
- **Availability of information in Wikipedia Library varies:** Wikipedia Library is used less often in Korean and Basque than German. One Korean editor cited a lack of information in Korean Wikipedia Library.
...
- **Foreign-language sources:** In communities like Basque where fewer references exist, other language sources, particularly “common” languages like English, French, Japanese, and Chinese, may be more acceptable.
...
const findings = [
	{
		"title": "Full Report",
		"url": "https://commons.wikimedia.org/wiki/File:Report_on_Verifiability_on_Wikimedia_May2021.pdf",
	},
]
</script>

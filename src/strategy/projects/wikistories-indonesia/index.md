---
title: "Wikistories Indonesia Concept Testing"
description: "Concept testing in the Indonesian wiki editor communities."
hero:
    image:
        src: "/strategy/projects/wikistories-indonesia/hero.opt.webp"
...
Please see the [final report](https://meta.wikimedia.org/wiki/File:Wikistories_Indonesia_(final_report).docx_(3).pdf) for a complete breakdown of results and recommendations. High-level takeaways are categorized into four areas: discovery, content, support, and ecosystem.
...
const findings = [
	{
		...
		"url": "https://meta.wikimedia.org/wiki/Research:Wikistories_Indonesia_Concept_Testing",
	},
	{
		"title": "Final Report",
		"url": "https://meta.wikimedia.org/wiki/File:Wikistories_Indonesia_(final_report).docx_(3).pdf",
	},
	{
		"title": "Related Projects",
		"url": "https://www.mediawiki.org/wiki/Wikistories",
	},
]
</script>
